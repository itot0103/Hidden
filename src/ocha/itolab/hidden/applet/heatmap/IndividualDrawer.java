...
public class IndividualDrawer implements GLEventListener {
	...
	public void setSpecifiedDimensionList(ArrayList list) {
		heatmap.setSpecifiedDimensionList(list);
	}
	
	public void setSpecifiedIndividualList(ArrayList list) {
		heatmap.setSpecifiedIndividualList(list);
	}
	
	public void setIndividualCliques(ArrayList<ArrayList> list) {
		heatmap.setIndividualCliques(list);
	}
	...
	public void init(GLAutoDrawable drawable) {
		...
		heatmap = new IndividualHeatmap(gl, gl2, glu, glu2, glut, glAD);
	}
