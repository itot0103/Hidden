...
public class SPIndividualCanvas extends JPanel {

	/* var */
	SPIndividualTransformer trans;
	SPIndividualDrawer drawer;
	BufferedImage image = null;
	GLCanvas glc;
	IndividualSet ps;
	ArrayList individuallist = null;
	...
	public SPIndividualCanvas(
		...
		drawer = new SPIndividualDrawer(width, height, glc);
		trans = new SPIndividualTransformer();
		trans.viewReset();
	...
	public SPIndividualCanvas(int width, int height) {
   ...
   public void setDrawer(SPIndividualDrawer d) {
		drawer = d;
	}

	
	public void setTransformer(SPIndividualTransformer t) {
		trans = t;
	}
	...
	public void setIndividualEdgeRatio(double r) {
		drawer.setIndividualEdgeRatio(r);
	}
	...
	public void mouseReleased(int x,int y) {
		...
		if(dragMode == 4) {
			individuallist = drawer.specifyIndividuals();
		}
	}
