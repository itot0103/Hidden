...
public class SPDimensionCanvas extends JPanel {

	/* var */
	SPDimensionTransformer trans;
	SPDimensionDrawer drawer;
	...
	public SPDimensionCanvas(
		...
		drawer = new SPDimensionDrawer(width, height, glc);
		trans = new SPDimensionTransformer();
		trans.viewReset();
	...
	public SPDimensionCanvas(int width, int height) {
   ...
   public void setDrawer(SPDimensionDrawer d) {
		drawer = d;
	}

	
	public void setTransformer(SPDimensionTransformer t) {
		trans = t;
	}
	...
	public void setDimensionEdgeRatio(double r) {
		drawer.setDimensionEdgeRatio(r);
	}
